...
function App() {
  ...
  // we have to use useCallback hook   :  that let u cache a function definition between re- renders 
  ...
  const copyPasswordToClipBoard =  useCallback( ()=> {
      ...
      // passwordRef.current?.setSelectionRange(0, 4) ; // to specify the range of the text which is going to be selected 
